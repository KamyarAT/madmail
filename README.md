...
> This branch is here for bug fixes related to the v1.0.0 version of madmail (go based madmail)
> madmail v1 never reached v1.0.0 but we call the go based madmail the v1. 
